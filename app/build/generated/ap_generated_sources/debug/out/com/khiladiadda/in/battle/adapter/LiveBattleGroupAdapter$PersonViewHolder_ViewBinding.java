...
public class LiveBattleGroupAdapter$PersonViewHolder_ViewBinding implements Unbinder {
  private LiveBattleGroupAdapter.PersonViewHolder target;

  @UiThread
  public LiveBattleGroupAdapter$PersonViewHolder_ViewBinding(
      LiveBattleGroupAdapter.PersonViewHolder target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    LiveBattleGroupAdapter.PersonViewHolder target = this.target;
