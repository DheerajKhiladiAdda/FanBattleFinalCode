...
public class TransactionAdapter$EventHolder_ViewBinding implements Unbinder {
  private TransactionAdapter.EventHolder target;

  @UiThread
  public TransactionAdapter$EventHolder_ViewBinding(TransactionAdapter.EventHolder target,
      View source) {
    this.target = target;
    ...
    target.mInvoiceBTN = Utils.findRequiredViewAsType(source, R.id.btn_invoice, "field 'mInvoiceBTN'", TextView.class);
  }

  @Override
  @CallSuper
  public void unbind() {
    TransactionAdapter.EventHolder target = this.target;
