...
public class PastBattleGroupAdapter$PersonViewHolder_ViewBinding implements Unbinder {
  private PastBattleGroupAdapter.PersonViewHolder target;

  @UiThread
  public PastBattleGroupAdapter$PersonViewHolder_ViewBinding(
      PastBattleGroupAdapter.PersonViewHolder target, View source) {
    this.target = target;
    ...
    target.mLiveGroupView = Utils.findRequiredView(source, R.id.view_live_group_div, "field 'mLiveGroupView'");
    target.mSelectedTV = Utils.findRequiredViewAsType(source, R.id.tv_total_selected, "field 'mSelectedTV'", TextView.class);
    target.layout = Utils.findRequiredViewAsType(source, R.id.parent, "field 'layout'", RelativeLayout.class);
  }

  @Override
  @CallSuper
  public void unbind() {
    PastBattleGroupAdapter.PersonViewHolder target = this.target;
    ...
    target.mLiveGroupView = null;
    target.mSelectedTV = null;
    target.layout = null;
  }
}
