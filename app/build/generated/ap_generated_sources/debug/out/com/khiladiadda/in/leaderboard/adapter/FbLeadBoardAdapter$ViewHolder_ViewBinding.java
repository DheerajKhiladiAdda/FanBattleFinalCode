...
public class FbLeadBoardAdapter$ViewHolder_ViewBinding implements Unbinder {
  private FbLeadBoardAdapter.ViewHolder target;

  @UiThread
  public FbLeadBoardAdapter$ViewHolder_ViewBinding(FbLeadBoardAdapter.ViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    FbLeadBoardAdapter.ViewHolder target = this.target;
