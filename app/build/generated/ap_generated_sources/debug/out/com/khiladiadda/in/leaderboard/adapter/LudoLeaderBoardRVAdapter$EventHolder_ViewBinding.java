...
public class LudoLeaderBoardRVAdapter$EventHolder_ViewBinding implements Unbinder {
  private LudoLeaderBoardRVAdapter.EventHolder target;

  @UiThread
  public LudoLeaderBoardRVAdapter$EventHolder_ViewBinding(
      LudoLeaderBoardRVAdapter.EventHolder target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    LudoLeaderBoardRVAdapter.EventHolder target = this.target;
