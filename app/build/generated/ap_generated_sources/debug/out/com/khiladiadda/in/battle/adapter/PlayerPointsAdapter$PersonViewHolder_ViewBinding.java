...
public class PlayerPointsAdapter$PersonViewHolder_ViewBinding implements Unbinder {
  private PlayerPointsAdapter.PersonViewHolder target;

  @UiThread
  public PlayerPointsAdapter$PersonViewHolder_ViewBinding(
      PlayerPointsAdapter.PersonViewHolder target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    PlayerPointsAdapter.PersonViewHolder target = this.target;
