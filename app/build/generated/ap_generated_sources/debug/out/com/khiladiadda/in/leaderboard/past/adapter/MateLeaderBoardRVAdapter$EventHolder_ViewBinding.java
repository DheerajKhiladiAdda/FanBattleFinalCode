...
public class MateLeaderBoardRVAdapter$EventHolder_ViewBinding implements Unbinder {
  private MateLeaderBoardRVAdapter.EventHolder target;

  @UiThread
  public MateLeaderBoardRVAdapter$EventHolder_ViewBinding(
      MateLeaderBoardRVAdapter.EventHolder target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    MateLeaderBoardRVAdapter.EventHolder target = this.target;
