...
public class FanBattleActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public FanBattleActivity_ViewBinding(FanBattleActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public FanBattleActivity_ViewBinding(FanBattleActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    FanBattleActivity target = this.target;
