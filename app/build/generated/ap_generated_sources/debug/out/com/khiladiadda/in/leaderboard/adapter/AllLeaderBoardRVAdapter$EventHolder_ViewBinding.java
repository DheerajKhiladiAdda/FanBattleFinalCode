...
public class AllLeaderBoardRVAdapter$EventHolder_ViewBinding implements Unbinder {
  private AllLeaderBoardRVAdapter.EventHolder target;

  @UiThread
  public AllLeaderBoardRVAdapter$EventHolder_ViewBinding(AllLeaderBoardRVAdapter.EventHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    AllLeaderBoardRVAdapter.EventHolder target = this.target;
