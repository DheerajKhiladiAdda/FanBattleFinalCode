...
public class FBBattleParticipantAdapter$EventHolder_ViewBinding implements Unbinder {
  private FBBattleParticipantAdapter.EventHolder target;

  @UiThread
  public FBBattleParticipantAdapter$EventHolder_ViewBinding(
      FBBattleParticipantAdapter.EventHolder target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    FBBattleParticipantAdapter.EventHolder target = this.target;
