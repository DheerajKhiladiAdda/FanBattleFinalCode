...
public class NewBeneficiaryAdapter extends RecyclerView.Adapter<NewBeneficiaryAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public NewBeneficiaryAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull NewBeneficiaryAdapter.ViewHolder holder, int position) {
