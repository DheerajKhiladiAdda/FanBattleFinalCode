...
public class WithdrawPresenter implements IWithdrawPresenter {
    ...
    @Override
    public void deleteBeneficiary(String id,int type) {
        mSubscription = mInteractor.deleteBeneficiary(id, type,mDeleteApiListener);
    }
    ...
    @Override
    public void onAddBeneficiaryEasebuzz(String bankAccount, String ifscCode, String transferMode, String vpa, int transferType) {
        AddBeneficiaryRequest request = new AddBeneficiaryRequest();
        request.setTransferType(transferType);
        request.setTransferMode(transferMode);
        request.setVpa(vpa);
    ...
    @Override
    public void onEasebuzzTransfer(String beneficiaryId, double amount, String otp) {
