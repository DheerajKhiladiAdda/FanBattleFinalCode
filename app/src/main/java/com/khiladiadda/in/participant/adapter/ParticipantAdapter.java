...
public class ParticipantAdapter extends RecyclerView.Adapter<ParticipantAdapter.EventHolder> {

    private Context mContext;
    private List<ParticipantDetails> mFDList;
    private IOnItemClickListener mOnItemClickListener;

    public ParticipantAdapter(Context context, List<ParticipantDetails> exhibitorList) {
    ...
    public void onBindViewHolder(EventHolder holder, int position) {
        ParticipantDetails details = mFDList.get(position);
        holder.mNameTV.setText(String.valueOf(details.getName()));
        holder.mUsernameTV.setText(String.valueOf(details.getGameUsername()));
