...
public class AppConstant {
  ...
  //  public static final String URL = "aHR0cHM6Ly9xYS5wcy5rLWFkZGEuY29tLw==";
 //production
    public static final String URL="aHR0cHM6Ly9wcm9kLnBzLnBoZmx5cnVkd3Muay1hZGRhLmNvbS8=";
    ...
    public static final String TEXT_CONTENT_TYPE_MULTIPART = "multipart/form-data";
    ...
    public static final String API_REMOVE_BENEFICIARY = "cashfree/remove/beneficiary/{beneId}/{type}";
  ...
  public static final String TEXT_BANNED = "You are not allowed to play this game in your state.";
  public static final String TEXT_BANNED_COUNTRY = "This app is only available for Indian users.";
  public static final String COINS_UPDATE = "COINS_UPDATE";
    ...
    public static final String APP_DIRECTORY_PATH = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getAbsolutePath() + File.separator + ".user";
//  public static final String APP_DIRECTORY_PATH = Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + ".user";
    ...
    public static final String INSUFFICIENT_WALLET_RECHARGE = "Your wallet balance is insufficient.\nPlease recharge your wallet to play";
    ...
    public static final String INVEST = "af_invest_fanBattle";
    public static final String GAME = "af_game";
  public static final String NO_OF_PARTICIPANTS="af_NoOfParticipants";
  ...
  public static final String CLASH_X_PARTICIPATE="af_CLASH_X_PARTICIPATE";
  public static final String CLASH_X_JoinPARTICIPATE="af_CLASH_X_join_PARTICIPATE";
  public static final String CLASH_X_ENTRY_FEE="af_CLASH_X_ENTRY_FEE";
  public static final String KYC_TIME="af_kyc_time";
  public static final String AMOUNT="af_AMOUNT";
