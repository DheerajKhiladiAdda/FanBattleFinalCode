...
import com.khiladiadda.in.network.model.request.AddCredential;
...
import com.khiladiadda.in.network.model.request.LudoBuddyChallengeRequest;
import com.khiladiadda.in.network.model.request.LudoContestRequest;
import com.khiladiadda.in.network.model.request.LudoErrorRequest;
import com.khiladiadda.in.network.model.request.LudoResultRequest;
import com.khiladiadda.in.network.model.request.LudoUpdateRequest;
import com.khiladiadda.in.network.model.request.ManualWithdrawRequest;
import com.khiladiadda.in.network.model.request.OpponentLudoRequest;
import com.khiladiadda.in.network.model.request.OtpRequest;
import com.khiladiadda.in.network.model.request.PANVerify;
...
import com.khiladiadda.in.network.model.request.QuizSubmitRequest;
...
import com.khiladiadda.in.network.model.request.StartQuizRequest;
import com.khiladiadda.in.network.model.request.TransferAmountRequest;
import com.khiladiadda.in.network.model.request.UpdateChatIdRequest;
...
import com.khiladiadda.in.network.model.response.BuddyResponse;
...
import com.khiladiadda.in.network.model.response.ClashRoyaleFilterReponse;
import com.khiladiadda.in.network.model.response.CreateTeamResponse;
import com.khiladiadda.in.network.model.response.FBParticipantResponse;
import com.khiladiadda.in.network.model.response.FactDetailsResponse;
import com.khiladiadda.in.network.model.response.FactsResponse;
...
import com.khiladiadda.in.network.model.response.LeaderBoardResponse;
import com.khiladiadda.in.network.model.response.LeagueListReponse;
import com.khiladiadda.in.network.model.response.LikeFactResponse;
import com.khiladiadda.in.network.model.response.LoginResponse;
import com.khiladiadda.in.network.model.response.LudoContestResponse;
...
import com.khiladiadda.in.network.model.response.MyLeagueResponse;
import com.khiladiadda.in.network.model.response.MyTeamResponse;
import com.khiladiadda.in.network.model.response.NotifyResponse;
...
import com.khiladiadda.in.network.model.response.PanResonse;
...
import com.khiladiadda.in.network.model.response.QuizListResponse;
import com.khiladiadda.in.network.model.response.QuizParticipantResponse;
import com.khiladiadda.in.network.model.response.QuizQuestionResponse;
import com.khiladiadda.in.network.model.response.QuizSubmitResponse;
...
import com.khiladiadda.in.network.model.response.StartQuizResponse;
import com.khiladiadda.in.network.model.response.TeamResponse;
import com.khiladiadda.in.network.model.response.TrendinQuizResponse;
import com.khiladiadda.in.network.model.response.UploadImageResponse;
import com.khiladiadda.in.network.model.response.UserQuizPlayedResponse;
...
public interface ApiService {
    ...
    Observable<AllLeaderBoardResponse> getLeaderboardMonth(@Query("page") int page, @Query("limit") int limit);
    ...
    Observable<AllLeaderBoardResponse> getGameLeaderBoardAll(@Path("id") String id, @Query("page") int page, @Query("limit") int limit);
...
//    Observable<MateResponse> getUserData(@Path("id") String id);
    ...
    Observable<BaseResponse> deleteBeneficiary(@Path("beneId") String id,@Path("type") int type);
    ...
    Observable<HTHMainResponse> getMyHTHBattle(@Query("banners") boolean banner, @Query("match_id") String id);
