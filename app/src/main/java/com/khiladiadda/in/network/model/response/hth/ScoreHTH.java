...
public class ScoreHTH implements Parcelable {
    ...
    public static final Parcelable.Creator<ScoreHTH> CREATOR = new Parcelable.Creator<ScoreHTH>() {
        @Override
        public ScoreHTH createFromParcel(Parcel source) {
            return new ScoreHTH(source);
        }

        @Override
        public ScoreHTH[] newArray(int size) {
            return new ScoreHTH[size];
        }
    };
}
