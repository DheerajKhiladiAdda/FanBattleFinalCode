 ...
 */
public class PaySharpApiManager {
    private static PaySharpApiManager sInstance;
     ...
     */
    public static PaySharpApiManager getInstance() {
        if (sInstance == null) {
            synchronized (PaySharpApiManager.class) {
                sInstance = new PaySharpApiManager();
            }
        }
        return sInstance;
    }
