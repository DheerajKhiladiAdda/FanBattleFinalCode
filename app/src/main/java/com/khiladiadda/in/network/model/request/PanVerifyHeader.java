...
public class PanVerifyHeader {
    ...
    public String getChannelVerison() {
        return channelVerison;
    }

    public void setChannelVerison(String channelVerison) {
        this.channelVerison = channelVerison;
    }
