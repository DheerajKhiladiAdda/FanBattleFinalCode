...
import com.khiladiadda.in.network.model.ErrorBody;
import com.khiladiadda.in.network.model.response.PanResonse;
import com.khiladiadda.in.utility.Logger;
...
public class PanSubscriberCallback<T> extends Subscriber<T> {

    private static final Logger LOGGER = Logger.getLogger(PanSubscriberCallback.class);
     ...
     */
    public PanSubscriberCallback(IApiListener<T> apiListenerWeakReference) {
    ...
    @Override public void onNext(T response) {
        ...
        PanResonse baseResponse = (PanResonse) response;
