...
public class CreateBattleDialog extends Dialog implements View.OnClickListener {
    ...
    public CreateBattleDialog(@NonNull Context context, IOnCreateBattleListener onCreateBattleListener, List<KaPlayerHTH> playerList) {
        super(context);
    ...
    private void checkData() {
        ...
        if (mAmountET.getText().toString().trim().isEmpty()) {
            ...
            AppUtilityMethods.showRechargeMsghth(getContext(),"Your wallet balance is insufficient.\nPlease recharge your wallet to play.");
            dismiss();
        } else {
