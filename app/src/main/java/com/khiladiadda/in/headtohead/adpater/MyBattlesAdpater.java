...
public class MyBattlesAdpater extends RecyclerView.Adapter<MyBattlesAdpater.PersonViewHolder> {
    ...
    @NonNull
    @Override
    public MyBattlesAdpater.PersonViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull MyBattlesAdpater.PersonViewHolder personViewHolder, int position) {
