...
import com.khiladiadda.in.network.model.response.hth.ResultList;
...
public class BattlesScoreActivity extends BaseActivity implements IHTHBattleView, SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LocalBroadcastManager.getInstance(this).registerReceiver(mHTHNotificationReceiverPastMatches, new IntentFilter("com.khiladiadda.in.HTH_MATCHES_PAST_NOTIFY"));
    }
    ...
    private void playerdata() {
        ...
        if (mResultList.get(0).getOpponentPoints() > mResultList.get(0).getCaptainPoints()) {
            ...
            Glide.with(this).load(mBattleList.getOpponent().getDp()).placeholder(R.mipmap.ic_launcher).into(mWinningIV);
...
////////////////////////////////////////////////////////////OPPonentTeam////////////////////////////////////////////////////////////////////////////////////////////
            ...
            Glide.with(this).load(mBattleList.getCaptain().getDp()).placeholder(R.mipmap.ic_launcher).into(mLosingIV);
...
//            substituteData(mIsCaptain, mBattleList);
            ...
            Glide.with(this).load(mBattleList.getCaptain().getDp()).placeholder(R.mipmap.ic_launcher).into(mWinningIV);
            if (!TextUtils.isEmpty(mBattleCaptainDetails.get(0).getImg()) && mBattleCaptainDetails.get(0).getImg().startsWith("https")) {
...
////////////////////////////////////////////////////////////OPPONENTTeam////////////////////////////////////////////////////////////////////////////////////////////
            ...
            Glide.with(this).load(mBattleList.getOpponent().getDp()).placeholder(R.mipmap.ic_launcher).into(mLosingIV);
            if (!TextUtils.isEmpty(mBattleOpponentDetails.get(0).getImg()) && mBattleOpponentDetails.get(0).getImg().startsWith("https")) {
