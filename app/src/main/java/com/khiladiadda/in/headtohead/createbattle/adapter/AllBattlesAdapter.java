...
public class AllBattlesAdapter extends RecyclerView.Adapter<AllBattlesAdapter.PersonViewHolder> {
    ...
    private int pos = -1;
    public AllBattlesAdapter(List<BattlesDeatilsHTH> mEventList, String mid) {
