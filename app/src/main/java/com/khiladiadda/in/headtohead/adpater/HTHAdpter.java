...
public class HTHAdpter extends RecyclerView.Adapter<HTHAdpter.ViewHolder> {
    ...
    @NonNull
    @Override
    public HTHAdpter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull HTHAdpter.ViewHolder holder, int position) {
