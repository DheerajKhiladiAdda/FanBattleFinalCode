...
import com.khiladiadda.in.interfaces.IOnFileDownloadedListener;
...
import com.khiladiadda.in.utility.DownloadApk;
...
public abstract class BaseActivity extends AppCompatActivity implements OnClickListener {
    ...
    private IOnVesrionDownloadListener mOnVersionListener = new IOnVesrionDownloadListener() {
        @Override
    ...
    private IOnFileDownloadedListener mOnFileDownloadedListener = new IOnFileDownloadedListener() {
        @Override
    ...
    private void installApk(String filePath) {
        ...
        if (Build.VERSION.SDK_INT >= 26 && !BaseActivity.this.getPackageManager().canRequestPackageInstalls()) {
            startActivity(new Intent(android.provider.Settings.ACTION_MANAGE_UNKNOWN_APP_SOURCES, Uri.parse("package:com.khiladiadda.in")));
