...
public class AllLeaderBoardRVAdapter extends RecyclerView.Adapter<AllLeaderBoardRVAdapter.EventHolder> {
    ...
    private AllLeaderBoardRVAdapter.IOnItemChildClickListener mOnItemChildClickListener;
    private int mFrom;
    ...
    public void setOnItemChildClickListener(AllLeaderBoardRVAdapter.IOnItemChildClickListener mOnItemChildClickListener) {
