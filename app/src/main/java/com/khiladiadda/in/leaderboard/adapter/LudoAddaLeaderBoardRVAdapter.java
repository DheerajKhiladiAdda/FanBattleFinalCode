...
public class LudoAddaLeaderBoardRVAdapter extends RecyclerView.Adapter<LudoAddaLeaderBoardRVAdapter.EventHolder> {
    ...
    @NonNull
    @Override
    public LudoAddaLeaderBoardRVAdapter.EventHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_leaderboard, parent, false);
        return new EventHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull LudoAddaLeaderBoardRVAdapter.EventHolder holder, int position) {
        int rank = 0;
