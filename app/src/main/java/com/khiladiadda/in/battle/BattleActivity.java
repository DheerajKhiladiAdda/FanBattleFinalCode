...
import com.khiladiadda.in.battle.adapter.BattleAdapter;
import com.khiladiadda.in.battle.adapter.BattleCategoryAdapter;
...
public class BattleActivity extends BaseActivity implements IBattleView, BattleAdapter.IOnItemChildClickListener, BattleCategoryAdapter.IOnItemChildClickListener {
    ...
    private void setData() {
        ...
        mAcitivtyName.setText(homeTeam.getName()+" vs "+awayTeam.getName());
