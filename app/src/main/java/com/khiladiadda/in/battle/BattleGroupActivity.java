...
import static com.khiladiadda.in.utility.AppConstant.NO_OF_PARTICIPANTS;
...
import com.khiladiadda.in.battle.adapter.BattleGroupAdapter;
import com.khiladiadda.in.battle.adapter.LiveBattleGroupAdapter;
import com.khiladiadda.in.battle.adapter.PastBattleGroupAdapter;
...
import com.khiladiadda.in.participant.ParticipantActivity;
...
public class BattleGroupActivity extends BaseActivity implements IBattleView, IOnItemClickListener, BattleGroupAdapter.IOnItemChildClickListener, LiveBattleGroupAdapter.IOnItemChildClickListener, PastBattleGroupAdapter.IOnItemChildClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private void setBattleData() {
        ...
        mActivityNameTV.setText(mBattleDetails.getTitle());
        if (mBattleDetails.isReverse()) {
            mHowtoPlay = 2;
    ...
    private void setData() {
        ...
        if (mFrom == AppConstant.FROM_FANBATTLE_LIVE) {
            /*Below line commit for only show fanBattle name*/
    ...
    public void onJoinComplete(BaseResponse responseModel) {
        ...
        eventParameters2.put(AppConstant.NO_OF_PARTICIPANTS,mBattleDetails.getNParticipants());
